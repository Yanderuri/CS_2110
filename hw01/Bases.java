...
public class Bases {
    ...
    public static int decimalStringToInt(String decimal) {
        ...
        for (int i = decimal.length() - 1; i >= 0; i--) {
            sum += (decimal.charAt(i) - 48) * currPower;
            currPower = 5 * currPower << 1;
        }
        return sum;
    }
    ...
    public static int hexStringToInt(String hex) {
        ...
        for (int i = hex.length() - 1; i >= 0; i--) {
            answer += (hex.charAt(i) - ((hex.charAt(i) <= '9') ? 48 : 55)) << (currPower);
            currPower += 4;
        }
        return answer;
    }
    ...
    public static String binaryStringToHexString(String binary) {
        ...
        while (answer.length() < 8 || sum != 0) {
            int tem = (sum & 0xF);
            answer = ((char) (tem + (tem < 10 ? 48 : 55))) + answer;
            sum >>= 4;
        }
        return answer;
    }
